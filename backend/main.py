...
app.mount("/data", StaticFiles(directory="../data"), name="media")
...
async def project_page(
    ...
    sql = f"""SELECT project_info.project_uuid, students.student_uuid, project_info.project_name, project_info.year_, 
                    ...
                    FROM project_info 
                        JOIN type_list
                        ON type_list.type_uuid = project_info.type_uuid
                        
                        JOIN group_list
                        ON group_list.group_uuid = project_info.group_uuid
                        
                        JOIN students
                        ON students.project_uuid = project_info.project_uuid
                        
                        JOIN files
                        ON files.project_uuid = project_info.project_uuid
